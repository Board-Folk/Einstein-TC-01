...
#ifndef Einsteinkeyboard_h
#define Einsteinkeyboard_h
...
#include "WProgram.h"
#endif
#define Einstein_KEYMAP_SIZE 	   152 // Size of each array in the key maps
...
//Einstein Special Keys
#define EinsteinGRPH_PIN     A3
#define EinsteinSHIFT_PIN    A0
#define EinsteinKRESET_PIN   A1       // Remix
#define EinsteinCTRL_PIN     A2
#define EinsteinALPH_PIN     A4       // Remix (256)
...
#define EinsteinRSHIFT  0x07
#define EinsteinCTRL    0x08
#define EinsteinCTRL2   0x09
#define EinsteinKRESET  0x04
#define EinsteinALPH    0x0a

class Einsteinkeyboard {
  public:
    Einsteinkeyboard();
    
    static void begin(const EinsteinKeymap_t &map = EinsteinKeymap_main);
};
#endif
